...
`)))}function q(n,t,o,a,r,l){let c=[],u={version:j,project:a,domain:r,endpoint:l,key:o,updatedAt:new Date().toISOString()};if(s.default.writeFileSync(i.default.join(n,".licenseguard.json"),JSON.stringify(u,null,2),"utf-8"),c.push(`  ${e.default.green("\u2713")} Konfigurasi Backup: ${e.default.bold(".licenseguard.json")}`),t==="nextjs"){A(n),c.push(`  ${e.default.green("\u2713")} Dependency: ${e.default.bold("@masdannn/license-guard "+$)}`);let d=i.default.join(n,"lib");s.default.existsSync(d)||s.default.mkdirSync(d,{recursive:!0});let b=`'use client';
...
`+f,"utf-8"),c.push(`  ${e.default.green("\u2713")} Import diinjeksi ke: ${e.default.bold(i.default.relative(n,p).replace(/\\/g,"/"))}`)),y=!0;break}y||c.push(`  ${e.default.yellow("!")} Tambahkan <LicenseGuard /> di root layout: ${e.default.cyan("import { LicenseGuard } from '@/lib/license-guard';")}`)}else if(t==="vite-react"||t==="vite-vue"||t==="vite-svelte"){A(n),c.push(`  ${e.default.green("\u2713")} Dependency: ${e.default.bold("@masdannn/license-guard "+$)}`);let d=i.default.join(n,"src","lib");s.default.existsSync(d)||s.default.mkdirSync(d,{recursive:!0});let b=`// \u26A1 Auto-generated by @masdannn/license-guard (v2) \u2014 JANGAN DIHAPUS
import { initGuard } from '@masdannn/license-guard';
...
`+g,s.default.writeFileSync(p,g,"utf-8"),c.push(`  ${e.default.green("\u2713")} Import diinjeksi ke: ${e.default.bold(i.default.relative(n,p).replace(/\\/g,"/"))}`)),y=!0;break}y||c.push(`  ${e.default.yellow("!")} Tambahkan di main entry file: ${e.default.cyan("import './lib/license-guard';")}`)}else if(t==="nuxt"){A(n);let d=i.default.join(n,"plugins");s.default.existsSync(d)||s.default.mkdirSync(d,{recursive:!0});let b=`import { initGuard } from '@masdannn/license-guard';
